...
const SECTIONS = [
  ...
  { title: "2. How We Use Your Information", body: `StraBook uses the information we collect to: process and confirm your bookings; send you transactional emails and booking confirmations; provide personalized celebrity recommendations; improve our Platform and develop new features; respond to your support inquiries; comply with legal obligations; and prevent fraud and abuse on our Platform.` },
  ...
  { title: "9. Children's Privacy", body: `StraBook does not knowingly collect personal information from individuals under the age of 18. If you become aware that a minor has provided us with personal information without parental consent, please contact us immediately. We will take steps to remove such data from our systems.` },
  { title: "10. Third-Party Links", body: `Our Platform may contain links to third-party websites or services that are not operated by StraBook. We are not responsible for the privacy practices of these third parties. We encourage you to review the privacy policies of any third-party sites you visit through links on our Platform.` },
  { title: "11. Changes to This Policy", body: `StraBook may update this Privacy Policy from time to time. We will notify you of significant changes by posting a prominent notice on our Platform or by sending you an email. Your continued use of the Platform after changes become effective constitutes acceptance of the revised Policy.` },
  { title: "12. Contact Us", body: `If you have questions, concerns, or requests regarding this Privacy Policy or your personal data, please contact our Data Privacy Officer at privacy@strabook.io. You may also write to us at StraBook Inc., 350 Fifth Avenue, New York, NY 10118, United States.` },
];
      ...
      <section className="px-5 py-20 max-w-[860px] mx-auto">
        ...
        <div className="mt-14 rounded-2xl border border-primary/20 p-9 flex items-center justify-between gap-6 flex-wrap"
          ...
          <div>
            ...
            <div className="text-muted-foreground/60 text-[13px] leading-relaxed">Reach our Data Privacy Officer at privacy@strabook.io</div>
          </div>
