...
export default function HomePage({ onView, onBook, favorites, onFav, setPage }) {
  ...
  return (
    <div>
      {/* ── HERO ── */}
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "120px 60px 100px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 860, position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: "clamp(52px,8vw,96px)", fontFamily: G.serif, color: G.cream, lineHeight: 1.0, margin: "0 0 28px", fontWeight: 800, letterSpacing: -2 }}>
            The Stage is<br /><span style={{ color: G.gold, fontStyle: "italic" }}>Yours.</span>
          </h1>
          <p style={{ color: G.muted, fontSize: "clamp(15px,1.8vw,19px)", lineHeight: 1.8, maxWidth: 560, margin: "0 0 44px", fontWeight: 400 }}>
          ...
          <div style={{ background: "rgba(42,42,42,0.7)", backdropFilter: "blur(16px)", border: `1px solid ${G.border}`, borderRadius: 50, padding: "6px 6px 6px 24px", display: "flex", alignItems: "center", gap: 12, maxWidth: 580, marginBottom: 28 }}>
            ...
            <input placeholder="Search celebrity, genre, or event type..." style={{ flex: 1, background: "transparent", border: "none", color: G.text, fontSize: 14, outline: "none", fontFamily: G.sans, padding: "10px 0" }} onFocus={() => setPage("celebrities")} />
      ...
      {/* ── TRUST BAR ── */}
      <div style={{ background: `linear-gradient(180deg, ${G.s1} 0%, ${G.bg} 100%)`, borderTop: `1px solid ${G.gold}25`, borderBottom: `1px solid ${G.border}`, padding: "56px 40px" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 24, textAlign: "center" }}>
          {[["500+", "Celebrity Roster"], ["100K+", "Happy Clients"], ["10+", "Years Experience"], ["24/7", "Concierge Support"]].map(([n, l], i) => (
            <div key={l} style={{ position: "relative" }}>
              <div style={{ fontSize: "clamp(32px,5vw,52px)", fontWeight: 800, color: G.gold, fontFamily: G.serif, lineHeight: 1, letterSpacing: -1 }}>{n}</div>
              <div style={{ color: G.muted, fontSize: 11, marginTop: 10, letterSpacing: 2, textTransform: "uppercase", fontWeight: 600 }}>{l}</div>
              {i < 3 && <div style={{ position: "absolute", right: 0, top: "10%", height: "80%", width: 1, background: `linear-gradient(to bottom, transparent, ${G.border}, transparent)` }} />}
            </div>
          ))}
        </div>
      </div>
      ...
      <section ref={featRef} className="reveal" style={{ padding: "100px 40px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56 }}>
          <div>
            ...
            <h2 style={{ fontSize: "clamp(30px,5vw,52px)", fontFamily: G.serif, color: G.cream, margin: "0 0 12px", fontWeight: 700 }}>Featured Talent</h2>
            <div style={{ height: 3, width: 64, background: `linear-gradient(90deg, ${G.gold}, ${G.goldD})`, borderRadius: 2 }} />
          </div>
          <button onClick={() => setPage("celebrities")} style={{ background: "none", border: "none", color: G.gold, cursor: "pointer", fontSize: 13, fontWeight: 700, display: "flex", alignItems: "center", gap: 6, fontFamily: G.sans, letterSpacing: 0.5 }}>View Full Roster →</button>
        </div>
        {/* Bento grid layout */}
        {(() => {
      ...
      {/* ── CATEGORIES ── */}
      <section ref={catsRef} className="reveal" style={{ background: G.bg, padding: "100px 60px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 24, marginBottom: 56 }}>
            <h2 style={{ fontFamily: G.serif, fontSize: "clamp(28px,4vw,48px)", fontWeight: 700, color: G.cream, margin: 0, whiteSpace: "nowrap" }}>Trending Now</h2>
            <div style={{ height: 1, background: G.border, flex: 1 }} />
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(220px,1fr))", gap: 20 }}>
            {CATS.map(cat => (
              <div key={cat.id} onClick={() => setPage("celebrities")} style={{ background: G.card, border: `1px solid ${G.border}`, borderRadius: 12, padding: "28px 24px", cursor: "pointer", transition: "all 0.3s cubic-bezier(0.4,0,0.2,1)" }}
                ...
                <div style={{ fontSize: 32, marginBottom: 18 }}>{cat.icon}</div>
                <div style={{ color: G.cream, fontWeight: 700, fontSize: 15, marginBottom: 4, fontFamily: G.serif }}>{cat.name}</div>
                <div style={{ color: G.gold, fontSize: 13, fontWeight: 700, marginBottom: 10 }}>{cat.n}</div>
                <div style={{ color: G.dim, fontSize: 12, lineHeight: 1.65 }}>{cat.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── SERVICES ── */}
      <section style={{ padding: "100px 60px", background: G.s1, borderTop: `1px solid ${G.border}` }}>
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ fontSize: "clamp(28px,5vw,52px)", fontFamily: G.serif, color: G.text, margin: "0 0 14px", fontWeight: 700 }}>Everything You Need</h2>
      ...
      {/* ── HOW IT WORKS ── */}
      <section ref={whyRef} className="reveal" style={{ background: G.bg, padding: "100px 60px" }}>
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            <h2 style={{ fontFamily: G.serif, fontSize: "clamp(32px,5vw,56px)", fontWeight: 700, color: G.text, margin: "0 auto", lineHeight: 1.1, maxWidth: 600 }}>Your vision, orchestrated by experts.</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32 }}>
            {[
              ...
              <div key={num} style={{ background: G.s1, border: `1px solid ${G.border}`, borderRadius: 20, padding: "40px 32px", position: "relative", overflow: "hidden" }}>
      ...
      {/* ── TESTIMONIALS ── */}
      <section ref={testRef} className="reveal" style={{ padding: "100px 60px", background: G.bg }}>
        <div style={{ maxWidth: 820, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "clamp(28px,5vw,50px)", fontFamily: G.serif, color: G.text, margin: "0 0 52px", fontWeight: 700 }}>What Our Clients Say</h2>
          <div style={{ background: G.s1, border: `1px solid ${G.border}`, borderRadius: 16, padding: "44px 52px", position: "relative", textAlign: "left" }}>
            ...
            <p style={{ color: G.muted, lineHeight: 1.9, fontSize: 16, fontStyle: "italic", margin: "0 0 32px" }}>{TESTIMONIALS[testimonialIdx].text}</p>
            <div style={{ borderTop: `1px solid ${G.border}`, paddingTop: 20, display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{ width: 44, height: 44, borderRadius: "50%", background: `linear-gradient(135deg, ${G.gold}40, ${G.goldD}30)`, border: `1px solid ${G.gold}30`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>👤</div>
              <div>
      ...
      {/* ── CTA BANNER ── */}
      <section style={{ position: "relative", padding: "120px 60px", overflow: "hidden", textAlign: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 860, margin: "0 auto" }}>
          <h2 style={{ fontFamily: G.serif, fontSize: "clamp(38px,6vw,80px)", fontWeight: 800, color: G.cream, margin: "0 0 32px", lineHeight: 1.05 }}>
            Elevate Your Next Event Beyond{" "}
            <span style={{ color: G.gold, fontStyle: "italic" }}>Expectation.</span>
          </h2>
          <p style={{ color: G.muted, fontSize: 17, maxWidth: 560, margin: "0 auto 44px", lineHeight: 1.8 }}>
            Join thousands of event planners, brands, and creators who trust StarBook for their most important moments.
          </p>
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <Btn onClick={() => setPage("celebrities")} style={{ padding: "18px 48px", fontSize: 14 }}>Start Your Inquiry</Btn>
            <Btn onClick={() => setPage("waitlist")} variant="outline" style={{ padding: "18px 48px", fontSize: 14 }}>Join Concierge Waitlist</Btn>
          </div>
        </div>
      </section>

      {/* ── NEWSLETTER ── */}
      <section style={{ background: G.s1, borderTop: `1px solid ${G.border}`, padding: "80px 60px", textAlign: "center" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px,4vw,40px)", fontFamily: G.serif, color: G.text, margin: "0 0 14px", fontWeight: 700 }}>Join Our Newsletter</h2>
          ...
          {subscribed ? (
            ...
            <div style={{ display: "flex", gap: 0, maxWidth: 460, margin: "0 auto", background: G.card, border: `1px solid ${G.border}`, borderRadius: 50, padding: "6px 6px 6px 22px", alignItems: "center" }}>
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com" style={{ flex: 1, background: "transparent", border: "none", color: G.text, fontSize: 14, outline: "none", fontFamily: G.sans }} />
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: "#0e0e0e", borderTop: `1px solid ${G.border}`, padding: "72px 60px 32px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 48, marginBottom: 60, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 52 }}>
              {[["Company", ["Press Kit", "About Us", "Contact"]], ["Services", ["Bookings", "Video Messages", "VIP Fan Card"]], ["Legal", ["Terms of Service", "Privacy Policy", "Cookies"]]].map(([title, links]) => (
                <div key={title}>
