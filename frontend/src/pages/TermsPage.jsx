...
const SECTIONS = [
  ...
  { title: "4. Booking Services", body: `StraBook acts as an intermediary platform that facilitates bookings between clients and celebrity talent. All bookings are subject to the individual availability and approval of the talent. StraBook does not guarantee the availability of any celebrity listed on the Platform. Booking confirmation is only final when you receive a written confirmation from StraBook.` },
  ...
  { title: "8. Intellectual Property", body: `All content on the StraBook Platform — including but not limited to text, graphics, logos, and software — is the property of StraBook or its licensors and is protected under applicable intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written permission.` },
  { title: "9. Limitation of Liability", body: `To the fullest extent permitted by law, StraBook shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits or data, arising from your use of the Platform or any booking made through it. Our total liability to you shall not exceed the amount paid by you to StraBook in the three months preceding the claim.` },
  ...
  { title: "11. Contact", body: `If you have any questions about these Terms, please contact our legal team at legal@strabook.io or write to us at StraBook Inc., 350 Fifth Avenue, New York, NY 10118, United States.` },
];
